...
class UserController extends Controller
{
	...
	public function actionDelete($id)
	{
		...
		if ($model->profile_picture_media_file_id != NULL)
			{
				$mediafiles= MediaFiles::model()->findByPk($model->profile_picture_media_file_id);
				$mediafiles->user_id= NULL;
				$mediafiles->save(false);
						
			}
			
			$model->saveAttributes(array('profile_picture_media_file_id' => null));

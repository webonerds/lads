	...
	<div id="mainmenu">
		<?php 
             ...
             $this->widget('zii.widgets.CMenu',array(
				...
				array('label'=>'Registration', 'url'=>array('/user/create'),'visible'=>yii::app()->user->isGuest),
				array('label'=>'My Profile', 'url'=>array('/user/view&id='.$id),'visible'=>!yii::app()->user->isGuest),

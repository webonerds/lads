...
<fieldset>
	...
	<section>
		...
		<div><?php echo $form->textField($model, 'description', array('required' => 'required')); ?></div>
	...
	<section>
		...
		<div><?php echo $form->textField($model, 'active', array('required' => 'required', 'type' => 'email')); ?></div>
...
JS;
$cs->registerScript('faqs-forms', $js, CClientScript::POS_END);
